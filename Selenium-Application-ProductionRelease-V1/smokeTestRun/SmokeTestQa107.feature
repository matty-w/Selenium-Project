Feature: Test107: QA - Check Elements Are Enabled on CMS Fleet Report Page - CMS Admin

	Scenario Outline: Test107: QA - Check Elements Are Enabled on CMS Fleet Report Page - CMS Admin
