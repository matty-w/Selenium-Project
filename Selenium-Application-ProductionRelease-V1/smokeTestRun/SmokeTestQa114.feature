Feature: Test114: QA - Check Elements Are Enabled on Assessment Report Raw Page - CMS Admin

	Scenario Outline: Test114: QA - Check Elements Are Enabled on Assessment Report Raw Page - CMS Admin
