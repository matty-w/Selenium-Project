Feature: Test094: QA - Check Elements Are Enabled on Assigned Claims Handler Incidents Page - CH Operator 

Scenario Outline: Test094: QA - Check Elements Are Enabled on Assigned Claims Handler Incidents Page - CH Operator 
