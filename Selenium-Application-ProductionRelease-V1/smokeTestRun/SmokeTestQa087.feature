Feature: Test087: QA - Check Elements Are Enabled on Outstanding Claims Handler Incidents Page - CH Operator : Action - Incident Details

Scenario Outline: Test087: QA - Check Elements Are Enabled on Outstanding Claims Handler Incidents Page - CH Operator : Action - Incident Details
