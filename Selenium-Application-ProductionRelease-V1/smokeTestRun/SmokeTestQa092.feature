Feature: Test092: QA - Check Elements Are Enabled on Outstanding Claims Handler Incidents Page - CH Operator : Action - Evidence Capture Forms : 1st Party Evidence

Scenario Outline: Test092: QA - Check Elements Are Enabled on Outstanding Claims Handler Incidents Page - CH Operator : Action - Evidence Capture Forms : 1st Party Evidence
