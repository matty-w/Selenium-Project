Feature: Test026: Impersonate RR Operator, Check Elements On Outstanding FNOL Incidents - RR Admin

Scenario Outline: Test026: QA - Impersonate RR Operator, Check Elements On Outstanding FNOL Incidents - RR Admin
