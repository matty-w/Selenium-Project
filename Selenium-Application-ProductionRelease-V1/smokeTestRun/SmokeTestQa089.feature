Feature: Test089: QA - Check Elements Are Enabled on Outstanding Claims Handler Incidents Page - CH Operator : Action - Collision Report

Scenario Outline: Test089: QA - Check Elements Are Enabled on Outstanding Claims Handler Incidents Page - CH Operator : Action - Collision Report
		...
		Examples:
			|browser |claims-table                      |action-button                                   |overview-tab                                             |incident-details-tab                                            |evidence-tab                                              |collision-tab                                                   |evidence-capture-tab                                                |correspondent-table                                                                            |add-comment-button                                                                                |comment-table                   |comment-cancel                                                                                        |comment-save                                                                                       |
