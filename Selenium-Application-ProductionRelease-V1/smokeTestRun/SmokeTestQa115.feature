Feature: Test115: QA - Check Elements Are Enabled on Assessment Report Tesco Page - CMS Admin

	Scenario Outline: Test115: QA - Check Elements Are Enabled on Assessment Report Tesco Page - CMS Admin
