Feature: Test029: Impersonate RR Operator, Check Elements On Assigned FNOL Incidents: Incident Details - RR Admin

Scenario Outline: Test029: QA - Impersonate RR Operator, Check Elements On Assigned FNOL Incidents: Incident Details - RR Admin
