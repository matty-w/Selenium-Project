Feature: Test015: Check Elements Are Enabled on Manage Fleet Page - RR Admin : Fleet Details

Scenario Outline: Test015: QA - Check Elements Are Enabled on Manage Fleet Page - RR Admin : Fleet Details
