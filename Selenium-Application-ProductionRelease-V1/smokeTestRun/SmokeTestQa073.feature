Feature: Test073: QA - Check Elements Are Enabled on Claim Incident Audit Trail Page - CH Supervisor

Scenario Outline: Test073: QA - Check Elements Are Enabled on Claim Incident Audit Trail Page - CH Supervisor
