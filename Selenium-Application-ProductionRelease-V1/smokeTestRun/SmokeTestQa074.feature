Feature: Test074: QA - Check Elements Are Enabled on Claim Incident Audit Trail Page - CH Supervisor : Action - Overview

Scenario Outline: Test074: QA - Check Elements Are Enabled on Claim Incident Audit Trail Page - CH Supervisor : Action - Overview
