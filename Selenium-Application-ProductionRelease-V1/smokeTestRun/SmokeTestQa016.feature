Feature: Test016: Check Elements Are Enabled on Manage Fleet Page - RR Admin : Vehicles

Scenario Outline: Test016: QA - Check Elements Are Enabled on Manage Fleet Page - RR Admin : Vehicles
