Feature: Test022: Impersonate RR Supervisor, Check Elements On FNOL Incident Audit Trail - RR Admin

Scenario Outline: Test022: QA - Impersonate RR Supervisor, Check Elements On FNOL Incident Audit Trail - RR Admin
