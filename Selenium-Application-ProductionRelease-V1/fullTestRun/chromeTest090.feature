Feature: Test090: Check The Assigned Analysis Elements (Overview) Are Enabled On Assigned Analysis Page (Overview) - CMS Operator

Scenario Outline: Test090: Check The Assigned Analysis Elements (Overview) Are Enabled On Assigned Analysis Page (Overview) - CMS Operator
		...
		Examples:
			|browser |nav-menu-id           |assigned-analysis-page                                   |analysis-list-table                   |incident-button                                     |overview-tab                                             |incident-tab                                                    |evidence-tab                                              |collision-tab                                                   |unassign-table|response-table                                                                    |add-response-button                                                                     |add-response-cancel                                                                |ar-button                                                                       |comment-table       |
			|"Chrome"|"ctl00_NavigationMenu"|"https://qa.cmsdriveguard.co.uk/AnalystAssignedList.aspx"|"ctl00_MainContent_grdAssignedAnalyst"|"ctl00_MainContent_grdAssignedAnalyst_ctl02_btnView"|"__tab_ctl00_MainContent_tcIncidnetDetails_tbpnloverview"|"__tab_ctl00_MainContent_tcIncidnetDetails_tbpnlincidentdetails"|"__tab_ctl00_MainContent_tcIncidnetDetails_tbpnlevidences"|"__tab_ctl00_MainContent_tcIncidnetDetails_tbpnlCollisionReport"|"tblActions"  |"ctl00_MainContent_tcIncidnetDetails_tbpnloverview_ucIncOverview_grdResponsesList"|"ctl00_MainContent_tcIncidnetDetails_tbpnloverview_ucIncOverview_btnAddResponseOverview"|"ctl00_MainContent_tcIncidnetDetails_tbpnloverview_ucIncOverview_btnCancelOverview"|"ctl00_MainContent_tcIncidnetDetails_tbpnloverview_ucIncOverview_btnAddOverview"|"tblResponseComment"|
