Feature: Test107: Check Elements Are Enabled on Assigned Claims Handler Incidents Page - CH Operator : Action - Incident Details

Scenario Outline: Test107: Check Elements Are Enabled on Assigned Claims Handler Incidents Page - CH Operator : Action - Incident Details
		...
		Examples:
			|browser |menuId                |assigned-page                                                 |action-button                                        |overview-tab                                             |incident-details-tab                                            |evidence-tab                                              |collision-tab                                                   |evidence-capture-tab                                                |unassign-table|response-table                                                                               |add-response-button                                                                        |comment-table       |comment-cancel                                                                        |comment-save                                                                       |
