Feature: Test033: Check Elements Are Enabled on Crash Audit Report Page - CMS Admin

	Scenario Outline: Test033: QA - Check Elements Are Enabled on Crash Audit Report Page - CMS Admin
