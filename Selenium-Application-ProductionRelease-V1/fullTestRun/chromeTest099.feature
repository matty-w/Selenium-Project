Feature: Test099: Check Elements Are Enabled on Outstanding Claims Handler Incidents Page - CH Operator : Action - Evidence

Scenario Outline: Test099: Check Elements Are Enabled on Outstanding Claims Handler Incidents Page - CH Operator : Action - Evidence
