Feature: Test009: Successful Login Test Claims Handler Supervisor

	Scenario Outline: Test009: QA - Attempt To Login/Logout With Correct Details (CH Supervisor)
	...
	|"Chrome" |"txtEmail"   |"test.cms05@collisionmanagementsystems.co.uk"|"QACHpassword1!"|"txtPassword"   |"LoginButton"|"class"      |"ctl00$btnLogOut"|"name"        |"https://qa.cmsdriveguard.co.uk/ClaimIncidentAuditTrail.aspx"|"https://qa.cmsdriveguard.co.uk/Account/Login"|
