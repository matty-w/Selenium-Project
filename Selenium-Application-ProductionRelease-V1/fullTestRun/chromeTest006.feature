Feature: Test006: Successful Login Test CMS Supervisor

	Scenario Outline: Test006: QA - Attempt To Login/Logout With Correct Details (CMS Supervisor)
	...
	|"Chrome" |"txtEmail"   |"test.cms08@collisionmanagementsystems.co.uk"|"QApassword1!"|"txtPassword"   |"LoginButton"|"class"      |"ctl00$btnLogOut"|"name"        |"https://qa.cmsdriveguard.co.uk/AnalysisAuditTrail.aspx"|"https://qa.cmsdriveguard.co.uk/Account/Login"|
