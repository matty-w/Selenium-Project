Feature: Test036: Check Elements Are Enabled on Video Viewer Page - CMS Admin

	Scenario Outline: Test036: Check Elements Are Enabled on Video Viewer Page - CMS Admin
