Feature: Test047: Check Elements Are Enabled on Email Manager Page - RR Admin

Scenario Outline: Test047: Check Elements Are Enabled on Email Manager Page - RR Admin
