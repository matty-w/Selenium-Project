Feature: Test114: Check Elements Are Enabled on Closed Claims Handler Incidents Page - CH Operator

Scenario Outline: Test114: Check Elements Are Enabled on Closed Claims Handler Incidents Page - CH Operator
