Feature: Test049: Check Elements Are Enabled on Analysis Audit Trail Page - CMS Supervisor : Incident Details - Overview

Scenario Outline: Test049: Check Elements Are Enabled on Analysis Audit Trail Page - CMS Supervisor : Incident Details - Overview
