Feature: Test012: Successful Login Test Rapid Responder Supervisor

	Scenario Outline: Test012: QA - Attempt To Login/Logout With Correct Details (RR Supervisor)
