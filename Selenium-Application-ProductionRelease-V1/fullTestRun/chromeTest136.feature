Feature: Test136: Check Elements Are Enabled on Closed FNOL Incidents - RR Operator

Scenario Outline: Test136: Check Elements Are Enabled on Closed FNOL Incidents - RR Operator
