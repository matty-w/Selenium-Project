Feature: Test032: Check Elements Are Enabled on Crash Confirmation Page - CMS Admin

	Scenario Outline: Test032: QA - Check Elements Are Enabled on Crash Confirmation Page - CMS Admin
