Feature: Test106: Check Elements Are Enabled on Assigned Claims Handler Incidents Page - CH Operator : Action - Overview

Scenario Outline: Test106: Check Elements Are Enabled on Assigned Claims Handler Incidents Page - CH Operator : Action - Overview
