Feature: Test070: Check Elements Are Enabled on Claim Incident Audit Trail Page - CH Supervisor : Action - Evidence

Scenario Outline: Test070: Check Elements Are Enabled on Claim Incident Audit Trail Page - CH Supervisor : Action - Evidence
