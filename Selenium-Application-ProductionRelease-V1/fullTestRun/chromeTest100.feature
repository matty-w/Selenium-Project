Feature: Test100: Check Elements Are Enabled on Outstanding Claims Handler Incidents Page - CH Operator : Action - Collision Report

Scenario Outline: Test100: Check Elements Are Enabled on Outstanding Claims Handler Incidents Page - CH Operator : Action - Collision Report
