Feature: Test031: Check Elements Are Enabled on Device Report Page - CMS Admin

	Scenario Outline: Test031: QA - Check Elements Are Enabled on Device Report Page - CMS Admin
