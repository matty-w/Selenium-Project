Feature: Test023: Check Elements Are Enabled on CMS Fleet Manager Page - CMS Admin

	Scenario Outline: Test023: QA - Check Elements Are Enabled on CMS Fleet Manager Page - CMS Admin
