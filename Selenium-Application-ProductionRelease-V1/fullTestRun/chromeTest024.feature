Feature: Test024: Check Elements Are Enabled on CMS Fleet Manager Page - CMS Admin: Fleet Details

	Scenario Outline: Test024: QA - Check Elements Are Enabled on CMS Fleet Manager Page - CMS Admin: Fleet Details
