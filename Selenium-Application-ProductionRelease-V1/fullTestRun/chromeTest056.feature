Feature: Test056: Check Elements Are Enabled on Assigned Analysis Page  - CMS Supervisor : Incident Details - Overview

Scenario Outline: Test056: Check Elements Are Enabled on Assigned Analysis Page  - CMS Supervisor : Incident Details - Overview
